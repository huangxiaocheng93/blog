...
路由器这个设备相信家家户户都有了，有些大户人家甚至有好多个。由于它工作在第三层，所以也叫他三层交换机。但是也别觉得它只工作在第三层，实际上不是，它同时也工作在第一层和第二层，但是我们现在主要讨论它在网络层的功能。
从名字就可以看出，路由器工作的重中之重就是**路由**。路由器是连接局域网和广域网的设备，它通常有两种端口：WAN口和LAN口，如图：
